...
var FullCalendar = function(e) {
    ...
    class al extends Gn {
        render() {
            let {
                ...
                seg: r
            } = e, i = pi(r, n.eventTimeFormat || il, t, !0, e.defaultDisplayEventEnd);
            return p(so, Object.assign({}, e, {
                elTag: "a",
    ...
    class bl extends ls {
        ...
        render() {
            let {
                ...
                options: r
            } = n, i = e.cells.length, s = nl(e.businessHourSegs, i), o = nl(e.bgEventSegs, i), a = nl(this.getHighlightSegs(), i), l = nl(this.getMirrorSegs(), i), {
                singleColPlacements: c,
                multiColPlacements: d,
                moreCnts: u,
                moreMarginTops: h
            } = ml(di(e.fgEventSegs, r.eventOrder), e.dayMaxEvents, e.dayMaxEventRows, r.eventOrderStrict, t.segHeights, t.maxContentHeight, e.cells), f = e.eventDrag && e.eventDrag.affectedInstances || e.eventResize && e.eventResize.affectedInstances || {};
            return p("tr", {
                ref: this.rootElRef,
                role: "row"
    ...
    class wl extends ls {
        constructor() {
            super(...arguments), this.slicer = new Dl, this.tableRef = {
                current: null
            }
        }
        render() {
        ...
        views: {
            dayGrid: {
                component: class extends xl {
                    constructor() {
                        super(...arguments), this.buildDayTableModel = Gt(_l), this.headerRef = {
                            current: null
                        }, this.tableRef = {
                            current: null
                        }
    ...
    class Sc extends ls {
        constructor() {
            super(...arguments), this.buildDayTableModel = Gt(_l), this.slicer = new Dl, this.state = {
                labelId: We()
            }
        }
        render() {
    ...
    }, e.version = "6.1.9", Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});