   ...
   @section('content')
       <div class="wptb-page-heading">
           <div class="wptb-item--inner" style="background-image: url('../assets/img/background/page-header-bg-2.jpg');">
               ...
               <h2 class="wptb-item--title ">Blog Detals</h2>
           </div>
       </div>
                       ...
                       <div class="blog-details-inner">
                           <div class="post-content">
                               <div class="post-header">
                                   <h2 class="post-title">Beginners guide to start your photography journey</h2>
                                   <div class="wptb-item--meta d-flex align-items-center gap-4">
                                       <div class="wptb-item wptb-item--author"><a href="#"><i
                                                   class="bi bi-pencil-square"></i> <span>Marina Willums</span></a></div>
                                       <div class="wptb-item wptb-item--date"><a href="#"><i
                                                   class="bi bi-calendar3"></i> <span>March 28, 2022</span></a></div>
                               ...
                               <div class="intro">
                                   <p> Kimono Photography is a full-service photography compa providing wedding, newborn,
                                       fashion &amp; portfolio photograpy. Our portfolio of completed work include highly
                                       acclaimed and award-winning projects for clients around
                                       the country &amp; globally also. </p>
                               </div>

                               <!-- Post Image -->
                               <figure class="block-gallery mt-4">
                                   <img src="images/details.jpg" alt="img">
                               </figure>

                               <div class="fulltext">
                                   <h4 class="widget-title">Project Concepts</h4>
                                   <p> Kimono Photography is a full-service photography company providing wedding, newborn,
                                       fashion &amp; portfolio grapy. Our portfolio of completed work includes highly
                                       acclaimed and award-winning projects</p>

                                   <ul class="point-order">
                                       <li><i class="bi bi-check2-all"></i> The talent at Kimono runs wide and deep. Across
                                           many markets, geographies</li>
                                   ...
                                   <p>
                                       Kimono Photography is a full-service photography compa providing wedding, newborn,
                                       fashion &amp; portfolio photograpy. Our portfolio of completed work include highly
                                       acclaimed and award-winning projects for clients around the country &amp; globally
                                       also.
                                   </p>
                                   ...
                                   <figure class="block-gallery mt-4">
                                       <a href="#"><img src="images/details2.jpg" alt="img"
                                               class="block-image"></a>
                                   </figure>
                                       ...
                                       <ul class="comment-list">
                                           <li class="comment even thread-even depth-1">
                                               <div class="commenter-block">
                                                   ...
                                                   <div class="comment-content">
                                                       <div class="comment-author-name">Barret Simpson <span
                                                               class="comment-date">January 29, 2023</span></div>
                                                       <div class="comment-author-comment">
                                                           <p>Lorem ipsum dolor sit amet, consectetur. Ut enim ad minima
                                                               veniam quis nostrum exercitationem mosequatu autem.</p>
                                                           <span class="comment-reply"><a href="#"
                                                                   class="comment-reply-link">Reply</a></span>
                                                       </div>
                                                   </div>
                                               </div>
                                               ...
                                               <ul class="children">
                                                   <li class="comment even thread-even depth-2">
                                                       <div class="commenter-block">
                                                           ...
                                                           <div class="comment-content">
                                                               <div class="comment-author-name">Parker Ballinger <span
                                                                       class="comment-date">January 22, 2023</span></div>
                                                               <div class="comment-author-comment">
                                                                   <p>Lorem ipsum dolor sit amet, consectetur. Ut enim ad
                                                                       minima veniam quis nostrum exercitationem mosequatu
                                                                       autem.</p>
                                                                   <span class="comment-reply"><a href="#"
                                                                           class="comment-reply-link">Reply</a></span>
                                                               </div>
                                           ...
                                           <li class="comment odd thread-odd depth-1">
                                               <div class="commenter-block">
                                                   ...
                                                   <div class="comment-content">
                                                       <div class="comment-author-name">Barret Simpson <span
                                                               class="comment-date">January 01, 2023</span></div>
                                                       <div class="comment-author-comment">
                                                           <p>Lorem ipsum dolor sit amet, consectetur. Ut enim ad minima
                                                               veniam quis nostrum exercitationem mosequatu autem.</p>
                                                           <span class="comment-reply"><a href="#"
                                   ...
                                   <div class="comment-respond">
                                       ...
                                       <form class="comment-form" action="register.php" method="post">
                                           <p class="logged-in-as">Your email address will not be published. Required
                                               fields are marked *</p>
                           ...
                           <div class="widget widget_block">
                               <div class="wp-block-group__inner-container">
                                   ...
                                   <ul class="wp-block-categories-list wp-block-categories">
                                       <li class="cat-item"><a href="#">Album</a> <i
                                               class="bi bi-chevron-right"></i></li>
                                       <li class="cat-item"><a href="#">Nature</a> <i
                                               class="bi bi-chevron-right"></i></li>
                                       <li class="cat-item"><a href="#">Decorative</a> <i
                                               class="bi bi-chevron-right"></i></li>
                                       <li class="cat-item"><a href="#">Newborn</a> <i
                                               class="bi bi-chevron-right"></i></li>
                                       <li class="cat-item"><a href="#">Wildlife</a> <i
                                               class="bi bi-chevron-right"></i></li>
                                       <li class="cat-item"><a href="#">Portfolio</a> <i
                                               class="bi bi-chevron-right"></i></li>
                                       <li class="cat-item"><a href="#">Abstract</a> <i
                                               class="bi bi-chevron-right"></i></li>
                                   </ul>
                               </div>
                           </div>
